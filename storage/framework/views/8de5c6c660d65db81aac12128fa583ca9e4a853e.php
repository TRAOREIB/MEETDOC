...
<form class="form-horizontal" role="form" method="POST" action=" <?php echo e(url('examen',[$ex->idexamen])); ?> " enctype="application/x-www-form-urlencoded" >
    ...
    <div class="col-sm-7" style="border:1px solid #D1DCF5;margin-left:0px;">
        <div class="form-group">
            ...
            <div class="col-sm-4"> 
                <input type="text" class="form-control" name="libelle" id="libelle"  value="<?php echo e($ex->libelle); ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3"> 
                <input type="text" class="form-control" name="type" id="type"  value="<?php echo e($ex->type); ?>">
...
<?php /**PATH C:\xampp\htdocs\montest6\resources\views/form_edit.blade.php ENDPATH**/ ?>