...
<!--        <script type="text/javascript" src="<?php echo e(asset('js/jquery.mCustomScrollbar.concat.min.js')); ?>"></script>
    ...
    <body>
        ...
        <br>
        <div class="">
            <a href="<?php echo e(route('medecin.create')); ?>" class="btn btn-primary" style="border: 1px solid #FFFFFF; background-color: #2a6496; border-radius: 0px;"><i class="glyphicon glyphicon-plus"></i> Nouveau </a>
        </div>
        <div class="" style="">
                    ...
                    <table class="table table-striped table-condensed" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="GET" action="<?php echo e(url('affectation')); ?>">
                                        ...
                                        <input type="hidden" value="<?php echo e($med->specialite); ?>" name="specialite">
                                        <input type="hidden" value="<?php echo e($med->id); ?>" name="idmedecin">
                                        
                                    </form>
                                </td>
                                <td title="Modifier">
                                    <form method="GET" action="<?php echo e(route('medecin.edit', [$med->id])); ?>">
                                ...
                                <td title="Supprimer">
                                    <form method="POST" action="<?php echo e(route('medecin.destroy', [$med->id])); ?>">
    ...
    <?php $__env->stopSection(); ?> 
<?php echo $__env->make('gentelella-master2.production.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\montest6\resources\views/medecin/liste.blade.php ENDPATH**/ ?>