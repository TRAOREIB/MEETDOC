...
<!--        <script type="text/javascript" src="<?php echo e(asset('js/jquery.mCustomScrollbar.concat.min.js')); ?>"></script>
   ...
   <?php $__env->stopSection(); ?>  
    ...
    <body>
        ...
        <br>
        <div class="">
            <a href="<?php echo e(route('laboratoires.create')); ?>" class="btn btn-primary" style="border: 1px solid #FFFFFF; background-color: #2a6496; border-radius: 0px;"><i class="glyphicon glyphicon-plus"></i> Nouveau </a>
        </div>
        <div class="table-responsive">               
                    <table class="col-xs-10" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo e($labo->nom); ?></td>
                                <td><?php echo e($labo->telephone); ?></td>
                                <td><?php echo e($labo->email); ?></td>
                                <td><?php echo e($labo->heureouverture); ?></td>
                                <td><?php echo e($labo->heurefermeture); ?></td>
                                
                                <td title="Modifier">
                                    <form method="GET" action="<?php echo e(route('laboratoires.edit', [$labo->idlabo])); ?>">
                                ...
                                <td title="Supprimer">
                                    <form method="POST" action="<?php echo e(route('laboratoires.destroy', [$labo->idlabo])); ?>">
...
<?php $__env->stopSection(); ?>  
<?php echo $__env->make('gentelella-master2.production.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\montest6\resources\views/laboratoire/liste.blade.php ENDPATH**/ ?>