...
<form class="was-validated" novalidate role="form" method="POST" action=" <?php echo e(url('examen',[$ex->idexamen])); ?> " enctype="application/x-www-form-urlencoded" >
            ...
            <div class="x_panel col-xs-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7 col-xs-12"> 
                        <input type="text" class="form-control" name="libelle" id="libelle"  value="<?php echo e($ex->libelle); ?>" required>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-12"> 
                        <input type="text" class="form-control" name="type" id="type"  value="<?php echo e($ex->type); ?>" required>
...
<?php echo $__env->make('gentelella-master2.production.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\montest6\resources\views/examen/form_edit.blade.php ENDPATH**/ ?>