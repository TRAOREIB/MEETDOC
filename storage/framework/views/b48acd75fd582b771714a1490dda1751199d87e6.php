...
<html lang="en">
    ...
    <body class="login" style="background-image: url(<?php echo e(asset('images/sante.jpg')); ?>); background-repeat: no-repeat;background-size:1400px">
        ...
        <div class="login_wrapper">
            <div class="animate form login_form">
                ...
                <div class="col-sm-8 col-xs-8 offset-4">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action=" <?php echo e(url('connect')); ?> " enctype="application/x-www-form-urlencoded">
                    ...
                    <div class="col-sm-10 col-xs-12">
                        <div class="change_link col-sm-4 " style="background-color: whitesmoke;border-radius: 10px">
                            <a href="<?php echo e(url('inscription')); ?>" class="to_register" style="margin-left: 45px"><b> Créer un Compte </b></a>
                        </div> <br><br>
                        <div class="change_link col-sm-4" style="background-color: whitesmoke;border-radius: 10px">
                            <a href="<?php echo e(url('inscription')); ?>" class="to_register" style="margin-left: 35px"><b> Mot de Passe oublié</b> </a> 
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\montest6\resources\views/connexion/login.blade.php ENDPATH**/ ?>