...
<body>
    ...
    <form class="was-validated" novalidate role="form" method="POST" action=" {{url('examen')}} " enctype="application/x-www-form-urlencoded" >
        {{ csrf_field() }}
                ...
                <div class="x_panel">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12"> 
                            ...
                            <small class="invalid-feedback">{{ $errors->first('condiremplir',':message') }}</small> 
                        </div> 
                    </div>
                    <br>
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12"> 
                            ...
                            <small class="invalid-feedback">{{ $errors->first('type',':message') }}</small> 
                        </div> 
                    </div>
