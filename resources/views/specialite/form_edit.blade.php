...
<form class="was-validated" novalidate role="form" method="POST" action=" {{url('specialite',[$sp->idspecialite])}} " enctype="application/x-www-form-urlencoded" >
    {{ method_field('PUT')}}
    {{ csrf_field() }}
            ...
            <div class="x_panel">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7 col-xs-12"> 
                        <input type="text" class="form-control" name="libelle" id="libelle"  value="{{$sp->libelle}}" required>
