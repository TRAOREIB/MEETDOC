...
<form class="form-horizontal" role="form" method="POST" action=" {{url('examen',[$ex->idexamen])}} " enctype="application/x-www-form-urlencoded" >
    {{ method_field('PUT')}}
        {{ csrf_field() }}
    ...
    <div class="col-sm-7" style="border:1px solid #D1DCF5;margin-left:0px;">
        <div class="form-group">
            ...
            <div class="col-sm-4"> 
                <input type="text" class="form-control" name="libelle" id="libelle"  value="{{$ex->libelle}}">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3"> 
                <input type="text" class="form-control" name="type" id="type"  value="{{$ex->type}}">
